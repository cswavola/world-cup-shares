...
function DistBars({ rows, elim = /* @__PURE__ */ new Set() }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-1", style: { padding: "0 12px" } }, rows.map((r) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: r.team, className: "flex items-center gap-2", style: { fontSize: 12 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: MONO, width: 34, color: T.sub } }, r.team), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, background: T.soft, borderRadius: 4, height: 14, overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { width: `${r.points / max * 100}%`, background: T.green, height: "100%", borderRadius: 4, minWidth: r.points > 0 ? 2 : 0 } })), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: MONO, width: 38, textAlign: "right", fontWeight: 700 } }, fmt(r.points), isElim ? " \u274C" : ""));
  }));
}
